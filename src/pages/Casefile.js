        ...
        <React.Fragment>
            ...
            {oneCase.evidence.map((ev, index) => (
                <React.Fragment key={index}>
                    ...
                    <h3>Location: </h3>                                <h3 className='appearance-none block w-1/6 bg-blue-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-blue-100 mt-2'>
                        {ev.location}
                    </h3>
                    </div>
                </React.Fragment>
